...
class FirebaseApiError extends Error {
  ...
  static final FirebaseApiError errorInvalidCustomToken =
      FirebaseApiError(17000);

  static final FirebaseApiError errorCustomTokenMismatch =
      FirebaseApiError(17002);

  /// sign in with credential error codes.
  static final FirebaseApiError errorInvalidCredential =
      FirebaseApiError(17004);

  static final FirebaseApiError errorUserDisabled = FirebaseApiError(17005);

  /// set account info error codes.
  static final FirebaseApiError errorOperationNotAllowed =
      FirebaseApiError(17006);

  static final FirebaseApiError errorEmailAlreadyInUse =
  ...
  /// sign in with credential error codes.
  static final FirebaseApiError errorAccountExistsWithDifferentCredential =
      FirebaseApiError(17012);

  /// set account info error codes.
  static final FirebaseApiError errorRequiresRecentLogin =
      FirebaseApiError(17014);

  /// link credential error codes
  static final FirebaseApiError errorProviderAlreadyLinked =
  ...
  static final FirebaseApiError errorNetworkRequestFailed =
  ...
  static final FirebaseApiError errorCredentialAlreadyInUse =
