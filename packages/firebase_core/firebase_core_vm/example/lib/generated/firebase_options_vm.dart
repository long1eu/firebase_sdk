...
FirebaseOptions get firebaseOptions {
  if (!kIsWeb && Platform.isAndroid) {
    return const FirebaseOptions(
      ...
      clientId:
          '233259864964-mv1iokuepc0vh7kmqbs2u6drtv2e5o49.apps.googleusercontent.com',
    ...
    return const FirebaseOptions(
      ...
      authDomain: 'flutter-sdk.firebaseapp.com',
      clientId:
          '233259864964-323cge6aj1nl7q3rkb2tgra9guu3p2ep.apps.googleusercontent.com',
      dataCollectionEnabled: true,
    );
  } else if (kIsWeb) {
    return const FirebaseOptions(
    ...
    return const FirebaseOptions(
      ...
      authDomain: 'flutter-sdk.firebaseapp.com',
      clientId:
          '233259864964-pnbmmuu4a7cfsjqm9iuk477jhrssqjje.apps.googleusercontent.com',
      dataCollectionEnabled: true,
    );
    ...
    return const FirebaseOptions(
      ...
      authDomain: 'flutter-sdk.firebaseapp.com',
      clientId:
          '233259864964-c60tim526nr289h3m7m5dsautlkc8o9c.apps.googleusercontent.com',
      dataCollectionEnabled: true,
    );
  } else {
